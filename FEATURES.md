...
- `ml/data_fetch.py`: fetches OHLCV candles from Yahoo Finance with Binance as a fallback. Includes a five-step backoff (5 / 15 / 45 / 90 / 150 seconds) and rotates between Yahoo `query1` and `query2` hosts to survive transient rate limits.
